  ...
  return (
    <section id="about" className="py-12 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-purple mb-8">
          About Me
        </h2>
        <div className="space-y-6 text-slate-600 leading-relaxed">
          <p className="font-medium">
I'm a <span className="font-bold text-brand-purple">Research & Data Science leader</span> who blends evidence and empathy to help companies focus on what matters most. At Intercom, I lead <span className="font-bold text-brand-purple">Team RAD</span>—a brilliant mix of AI-forward researchers and data scientists who use qualitative and quantitative methods to inform decision-making, fuel product innovation, and shape more intelligent, human-centered experiences.
          </p>
          <p className="font-medium">
Before Intercom, I spent 8 years in scientific research labs - Yahoo and Telefónica - leading teams of scientists and conducting research of my own at the intersection of <span className="font-bold text-brand-purple">human-computer interaction, AI, and mobile computing</span>. My research helped power products like Yahoo Mobile Search, Flurry, Aviate, and Gemini. I have a PhD in Computer Science from UCD, a strong technical background, and have published over 30 peer-reviewed papers in top-tier conferences and journals across human computer interaction, mobile computing, information retrieval and recommender systems.
          </p>
          <p className="font-medium">
In 2017 I founded <span className="font-bold text-brand-purple">HER+Data</span>, a community supporting women in analytics and data science. Over nearly eight years, we built a community of &gt; 1000 people, hosted 36 events, featured 80+ speakers, and created an empowering space where women found their voice, built skills, and supported each other's growth. HER+Data Dublin came to a close in 2025 - a bittersweet but intentional decision. I'm deeply proud of the space we built together.
          </p>
          <p className="font-medium">
I care about building products that solve actual problems, nurturing <span className="font-bold text-brand-purple">happy, high-performing teams</span>, and sharing what I've learned along the way. You'll find me writing, speaking, or mentoring in spaces where research, data science, leadership, AI and impact meet.
          </p>
          <p className="font-medium">
