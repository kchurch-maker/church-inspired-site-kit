          ...
          <div className="space-y-4">
            <div>
              <p className="text-slate-800">
                ...
                <br/> <em>Intercom RAD, Medium</em> (April 2025) <a href="https://medium.com/intercom-rad/rewriting-the-rules-how-ai-is-transforming-research-data-science-and-beyond-f1ecc579ffa7" className="text-blue-600 hover:text-blue-800"> 🔗 Link</a>
              </p>
            </div>
