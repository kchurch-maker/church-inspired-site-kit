  ...
  return (
    <section id="writing-speaking" className="py-24 px-6 lg:px-8 bg-purple-100 text-slate-800">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Overview */}
        <div className="mb-16 text-slate-700 leading-relaxed">
          <p className="mb-4">
           ...
           <div>
            ...
            <div>
              <p className="text-slate-800">
                ...
                <em>InspireFest</em> (July 2017) <a href="#" className="text-purple-600 hover:text-purple-800 underline">📹 Video</a>
              </p>
            </div>
            ...
            <div>
              <p className="text-slate-800">
                ...
                <em>Predict 2017</em> (Oct 2016) <a href="#" className="text-purple-600 hover:text-purple-800 underline">📹 Video</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              <p className="text-slate-800">
                ...
                <br/> <em>Intercom RAD, Medium</em> (April 2025) <a href="https://medium.com/intercom-rad/rewriting-the-rules-how-ai-is-transforming-research-data-science-and-beyond-f1ecc579ffa7" className="text-purple-600 hover:text-purple-800 underline"> 🔗 Link</a>
              </p>
            </div>
