...
const WritingSpeaking = () => {
  return (
    <section id="writing-speaking" className="py-24 px-6 lg:px-8 bg-purple-900 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Overview */}
        <div className="mb-16 text-purple-100 leading-relaxed">
          <p className="mb-4">
           ...
           <div>
            ...
            <div>
              <p className="text-white">
                ...
                <em>InspireFest</em> (July 2017) <a href="#" className="text-purple-300 hover:text-purple-100 underline">📹 Video</a>
              </p>
            </div>
        ...
        {/* Selected Writing */}
        <div>
          <h3 className="text-xl font-light text-purple-200 mb-6">Selected Writing</h3>
          <div className="space-y-4">
            <div>
              <p className="text-white">
                <strong>Rewriting the Rules: How AI is Transforming Research, Data Science, and Beyond</strong>
                <br/> <em>Intercom RAD, Medium</em> (April 2025) <a href="https://medium.com/intercom-rad/rewriting-the-rules-how-ai-is-transforming-research-data-science-and-beyond-f1ecc579ffa7" className="text-purple-300 hover:text-purple-100 underline"> 🔗 Link</a>
              </p>
            </div>
