    ...
    <section className="min-h-screen flex items-center justify-center px-6 lg:px-8 pb-12">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        <div className="flex-shrink-0 relative">
          ...
          <div className="absolute -inset-4 bg-brand-yellow rounded-full"></div>
          <Avatar className="w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 relative z-10 border-4 border-white shadow-lg">
            <AvatarImage 
        ...
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-slate-800 mb-8 leading-tight">
            Hello, I'm <span className="font-bold text-brand-purple">Karen Church</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
            A passionate <span className="font-bold text-brand-purple">Research & Data Science leader</span> who turns data into decisions that matter.
          </p>
        </div>
      </div>
    </section>
